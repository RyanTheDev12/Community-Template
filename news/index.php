...
<html>
<head>
	<title>News - <?php echo $name ?></title>
	...
	<style>
		...
		.body .screen .bottom p {
			font-size: 1.5vh;
			color: #fff;
			margin: 0;
		}

		.body .screen .bottom .left, .body .screen .bottom .right {
			width: 50%;
			text-align: left;
		}

		.body .screen .bottom .right {
			text-align: right;
		}
	  	...
	  	<div class="screen">
	  		<div class="spacer">
	  			<div class="center">
		  			...
		  			<div class="items">
			  			<?php
			  				foreach ($news as $item => $information) {
			  			?>
			  				<div class="item">
			  					<div class="message">
			  						<h2><?php echo $item ?></h2>
			  						<p><?php echo $information['message'] ?>
			  					</div>
			  					<div class="bottom">
			  						<div class="left">
